...
#' Data 1 - saved as data_matrix, contains gene symbols or ID's along with the expression data as sample1, sample2, .., sampleN in corresponding columns
...
#' Data 3 (optional) - saved as data_dictionary, contains only gene symbols or ID's (typically the 1st column from 'data_matrix' with same column name)
